...
//# sourceMappingURL=webcam.video.directive.js.map
/* Min file (c) */
...
//# sourceMappingURL=webcam.webcam.service.js.map
/* Min file (c) */
"use strict";!function(){function a(){var a={restrict:"E",templateUrl:"/Components/WebCam/webcam.webcam.template.html",scope:{connector:"=controls"},controller:b};return a}function b(a,b){function c(){d.serviceValues=b.getValues(),a.connector.imageValues=d.serviceValues}var d=a.model={};c(),a.onSnapPhoto=function(){b.captureFrame()},a.onDeletePhoto=function(a){b.deletePhoto(a)}}angular.module("webcam").directive("webCam",a).controller("WebCamController",b),b.$inject=["$scope","WebCamService"]}();
//# sourceMappingURL=webcam.webcam.directive.js.map
/* Min file (c) */
...
//# sourceMappingURL=fields-generator.service.js.map
/* Min file (c) */
...
/* Min file (c) */
!function(){function a(a,b){function c(){b.getValue("TabOptionsDataServiceValues").then(function(a){a&&angular.extend(h,a)})}function d(){return h}function e(a){return h[a]}function f(a,c){h[a]=c,b.setValue("TabOptionsDataServiceValues",h)}var g={},h={};return g.initialize=c,c(),g.getValues=d,g.getTabOptions=e,g.setTabOptions=f,g}angular.module("controls-module").service("TabOptionsDataService",a),a.$inject=["LocalStorageService","DBService"]}();
//# sourceMappingURL=tab-options-data.service.js.map
/* Min file (c) */
!function(){function a(a,b,c,d,e,f,g){function h(a,b){a.heirarchyLabels||(a.heirarchyLabels=[]),a.heirarchyLabels=(angular.isDefined(b)&&angular.isDefined(b.heirarchyLabels)?angular.copy(b.heirarchyLabels):[]).concat(a.heirarchyLabels);var c=i(a);c&&a.heirarchyLabels.push(c)}function i(a){return"Collapsible"===a.type&&a.properties.heading?a.properties.heading:"CheckboxGroup"===a.type&&a.name?a.name:void 0}function j(a,b){angular.isUndefined(b)||(a.heirarchyLabels=b.heirarchyLabels?angular.copy(b.heirarchyLabels):[])}function k(a){e.set("RadioGroupCount",e.get("RadioGroupCount")+1),a.controls.groupname="RadioGroup"+e.get("RadioGroupCount"),a.controls.labelPrefix=e.get("tabHierarchyHeadings"),a.controls.name=a.controls.properties.legend,void 0===a.controls.properties.id&&(a.controls.properties.id="RadioGroup"+e.get("RadioGroupCount"));var f=b.getTabOptions(a.controls.properties.tabId);a.$watch("controls.value",function(b,g){if(void 0!==b){var h={controlId:a.controls.properties.id,label:a.controls.labelPrefix+a.controls.properties.legend,heirarchyLabels:a.controls.heirarchyLabels,type:a.controls.type,valueLabel:a.controls.value,value:a.controls.value,labelPrefix:a.controls.labelPrefix,categoriesInfo:a.controls.categorieschildren,control:a.controls};v(h),d.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,u(h,f),f&&f.properties&&c.addTabProperties(h,f.properties),!e.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&f&&(f.properties.useClassificationPanelInput||f.properties.useRightPanelInput)&&t(f.properties)}else d.removeControl(a.controls.properties.id),a.controls.showCategory=!1,e.setRecentlySelectedControlDetails(void 0)}),s(a,f)}function l(a){a.controls.name=a.controls.properties.legend,angular.forEach(a.controls.children,function(b,c){b.name=a.controls.name})}function m(a,f,g){var h=e.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(h)?h:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=e.get("tabHierarchyHeadings");var i=b.getTabOptions(a.controls.properties.tabId);s(a,i),a.$watch("controls.value",function(b,f){if(b!==!0||f!==!1&&void 0!==f)b===!1&&f===!0&&(d.hasControl(a.controls.properties.id)&&d.removeControl(a.controls.properties.id),a.controls.showCategory=!1,e.setRecentlySelectedControlDetails(void 0));else{var g={label:a.controls.name?a.controls.name:"",heirarchyLabels:a.controls.heirarchyLabels,valueLabel:a.controls.properties.label,control:a.controls};v(g),d.addControl(a.controls.properties.id,g),a.controls.showCategory=!0,c.addControlDetails(g,a.controls),i&&i.properties&&c.addTabProperties(g,i.properties),u(g,i),!e.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&i&&(i.properties.useClassificationPanelInput||i.properties.useRightPanelInput)&&t(i.properties)}})}function n(a,f){a.controls.value||(a.controls.value=0);var g=e.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(g)?g:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=e.get("tabHierarchyHeadings");var h=b.getTabOptions(a.controls.properties.tabId);f.on("change",'input[type="number"]',function(){var b=parseInt($(this).val());if(!(0>=b)){a.controls.value=b;var f={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.value,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};v(f),d.addControl(a.controls.properties.id,f),u(f,h),h&&h.properties&&c.addTabProperties(f,h.properties),a.controls.showCategory=!0,!e.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&h&&(h.properties.useClassificationPanelInput||h.properties.useRightPanelInput)&&t(h.properties),a.$apply()}}),a.$watch("controls.value",function(a){$(f).find('input[type="number"]').val(a).slider().slider("refresh")}),s(a,h)}function o(a){var f=e.get("uniqueProperty");a.controls.uniqueProperty=f,a.controls.properties.id=f+a.controls.properties.id,a.controls.labelPrefix=e.get("tabHierarchyHeadings");var g=b.getTabOptions(a.controls.properties.tabId);a.$watch("controls.value",function(b,f){if(void 0!==b&&""!==b){var h={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.value,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};v(h),d.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,u(h,g),g&&g.properties&&c.addTabProperties(h,g.properties),!e.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&(g.properties.useClassificationPanelInput||g.properties.useRightPanelInput)&&t(g.properties)}else d.hasControl(a.controls.properties.id)&&d.removeControl(a.controls.properties.id),a.controls.showCategory=!1,e.setRecentlySelectedControlDetails(void 0)}),s(a,g)}function p(a){e.set("SliderCount",e.get("SliderCount")+1),void 0===a.controls.properties.id&&(a.controls.properties.id="ToggleSwitch"+e.get("SliderCount")),(void 0===a.controls.properties.label||""===a.controls.properties.label)&&(a.controls.properties.label=e.get("TextLabel")),e.set("TextLabel","");var f=e.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(f)?f:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=e.get("tabHierarchyHeadings");var g=b.getTabOptions(a.controls.properties.tabId);a.controls.value="false",a.$watch("controls.value",function(b,f){if("true"===b&&"false"===f){var h={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.properties.label1,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren};v(h),d.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,u(h,g),g&&g.properties&&c.addTabProperties(h,g.properties),!e.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&(g.properties.useClassificationPanelInput||g.properties.useRightPanelInput)&&t(g.properties)}else"false"===b&&(d.removeControl(a.controls.properties.id),a.controls.showCategory=!1,e.setRecentlySelectedControlDetails(void 0))}),s(a,g)}function q(a,f){e.set("SelectMenuCount",e.get("SelectMenuCount")+1),void 0===a.controls.properties.id&&(a.controls.properties.id="SelectMenu"+e.get("SelectMenuCount")),a.controls.labelPrefix=e.get("tabHierarchyHeadings"),a.controls.properties.options&&a.controls.properties.options.children&&(a.controls.previousValue=a.controls.value=a.controls.defaultValue=a.controls.properties.options.children[0].value,a.controls.previousValueLabel=a.controls.valueLabel=a.controls.defaultValueLabel=a.controls.properties.options.children[0].text);var g=b.getTabOptions(a.controls.properties.tabId);f.on("change","select.control",function(b){var f=$(this).val(),h=$('option[value="'+f+'"]:selected',$(this)).text();if(f!==a.controls.previousValue&&f!==a.controls.defaultValue||h!==a.controls.previousValueLabel&&h!==a.controls.defaultValueLabel){a.controls.previousValue=a.controls.value,a.controls.previousValueLabel=a.controls.valueLabel,a.controls.value=f,a.controls.valueLabel=h;var i={controlId:a.controls.properties.id,label:a.controls.properties.label||a.controls.properties.options.label,type:a.controls.type,valueLabel:a.controls.valueLabel,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren};v(i),d.addControl(a.controls.properties.id,i),a.controls.showCategory=!0,u(i,g),g&&g.properties&&c.addTabProperties(i,g.properties),!e.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&(g.properties.useClassificationPanelInput||g.properties.useRightPanelInput)&&t(g.properties)}else d.removeControl(a.controls.properties.id),a.controls.showCategory=!1,e.setRecentlySelectedControlDetails(void 0);a.$digest()}),s(a,g)}function r(a){var b=a.controls,c=b.properties&&b.properties.rows?b.properties.rows:1;void 0===b.properties&&(b.properties={}),b.properties.uiClass=GridBuilder.getGridClass(b.children,c),GridBuilder.setGridControlLabels(b)}function s(a,b){if(a.controls.attachCategories&&b&&(b.properties.useClassificationPanelInput||b.properties.useRightPanelInput)&&!a.controls.categorieschildren){var c;b.properties.useClassificationPanelInput?c=angular.copy(b.leftPanelCategoriesList.controls[0].categorieschildren):b.properties.useRightPanelInput&&(c=angular.copy(b.rightPanelCategoriesList.controls[0].categorieschildren)),updateId(a.controls.properties.id,e.get("uniqueProperty"),c),e.get("ClassificationDataAdded").push({controlId:a.controls.properties.id,uniqueProperty:e.get("uniqueProperty"),classification:c}),a.controls.categorieschildren=c}}function t(a){var b;a.useClassificationPanelInput?b="leftpanel":a.useRightPanelInput&&(b="rightpanel"),$("#"+b).panel("open"),$("#closePanelButton").removeClass("ui-btn-active")}function u(a,b){b&&b.properties.useClassificationPanelInput?e.setRecentlySelectedControlDetails(a):b&&b.properties.useRightPanelInput&&g.setPanelData("right",a)}function v(a){var b=(a.labelPrefix?a.labelPrefix:"")+(a.label?(a.labelPrefix?" : ":"")+a.label:"")+(a.heirarchyLabels&&a.heirarchyLabels.length>0?" : "+a.heirarchyLabels.join(" : "):"");a.controlLabel=b}var w={};return w.processHierarchyLabelsForContainer=h,w.processHierarchyLabelsForControl=j,w.processRadioGroup=k,w.processCheckboxGroup=l,w.processCheckbox=m,w.processSlider=n,w.processTextInput=o,w.processToggleSwitch=p,w.processSelectMenu=q,w.processGrid=r,w.openPanel=t,w}angular.module("controls-module").service("DirectiveHelperService",a),a.$inject=["ControlsService","TabOptionsDataService","selectedControlsOptionsService","SelectedControlsService","SharedDataService","specificClassificationService","panelDataService"]}();
//# sourceMappingURL=directive-helper.service.js.map
/* Min file (c) */
...
//# sourceMappingURL=specific-classification.service.js.map
/* Min file (c) */
"use strict";!function(){angular.module("selected-controls-module",[])}();
//# sourceMappingURL=selected-controls.module.js.map
/* Min file (c) */
!function(){function a(){function a(){return m}function b(a,b){m.selectedControls[a]=b}function c(a){delete m.selectedControls[a]}function d(a){return angular.isDefined(m.selectedControls[a])}function e(){return m.selectedControls}function f(a){return m.selectedControls[a]}function g(){var a={};return angular.forEach(m.selectedControls,function(b,c){a[c]=b}),a}function h(a){m.selectedControls=a}function i(){m.selectedControls={}}function j(a){angular.forEach(m.selectedControls,function(b,c){var d=k(a,c);console.log(d),null!==d&&(m.selectedControls[c].control=d)})}function k(a,b){if(angular.isArray(a)){for(var c=0;c<a.length;c++){var d=a[c];if(d.properties&&d.properties.id===b)return d;if(d.children)return k(d.children,b)}return foundControl}return a.properties&&a.properties.id===b?a:a.children?k(a.children,b):null}var l={},m={selectedControls:{}};return l.getValues=a,l.addControl=b,l.removeControl=c,l.hasControl=d,l.getSelectedControls=e,l.getControlDetails=f,l.getSelectedControlsCopy=g,l.setSelectedControls=h,l.clearSelectedControls=i,l.updateSelectedControls=j,l}angular.module("selected-controls-module").service("SelectedControlsService",a)}();
//# sourceMappingURL=selected-controls.service.js.map
/* Min file (c) */
"use strict";!function(){function a(){function a(a,b){a.type=b.type,a.controlId=b.properties.id,a.value=b.value,a.labelPrefix=b.labelPrefix,a.categorieschildren=b.categorieschildren}function b(a,b){a.tabProperties=b}var c=this;c.addControlDetails=a,c.addTabProperties=b}angular.module("selected-controls-module").service("selectedControlsOptionsService",a)}();
//# sourceMappingURL=selected-controls-options.service.js.map
/* Min file (c) */
