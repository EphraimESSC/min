...
/* Min file (c) */
!function(){function a(a,b,c,d,e,f){function g(a,b){a.heirarchyLabels||(a.heirarchyLabels=[]),a.heirarchyLabels=(angular.isDefined(b)&&angular.isDefined(b.heirarchyLabels)?angular.copy(b.heirarchyLabels):[]).concat(a.heirarchyLabels);var c=h(a);c&&a.heirarchyLabels.push(c)}function h(a){return"Collapsible"===a.type&&a.properties.heading?a.properties.heading:"CheckboxGroup"===a.type&&a.name?a.name:void 0}function i(a,b){angular.isUndefined(b)||(a.heirarchyLabels=b.heirarchyLabels?angular.copy(b.heirarchyLabels):[])}function j(a){d.set("RadioGroupCount",d.get("RadioGroupCount")+1),a.controls.groupname="RadioGroup"+d.get("RadioGroupCount"),a.controls.labelPrefix=d.get("tabHierarchyHeadings"),a.controls.name=a.controls.properties.legend,void 0===a.controls.properties.id&&(a.controls.properties.id="RadioGroup"+d.get("RadioGroupCount"));var f=b.getTabOptions(a.controls.properties.tabId);a.$watch("controls.value",function(b,g){if(void 0!==b){var h={controlId:a.controls.properties.id,label:a.controls.labelPrefix+a.controls.properties.legend,heirarchyLabels:a.controls.heirarchyLabels,type:a.controls.type,valueLabel:a.controls.value,value:a.controls.value,labelPrefix:a.controls.labelPrefix,categoriesInfo:a.controls.categorieschildren,control:a.controls};u(h),c.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,t(h,f),f&&f.properties&&e.setSpecifiClassificationDetails(h,f.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&f&&f.properties.inputPanelToUseInDiagnoseTab&&!f.properties.selectSpecificClassification&&s(f.properties.inputPanelToUseInDiagnoseTab)}else delete d.get("SelectedControls")[a.controls.properties.id],a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0)}),r(a,f)}function k(a){a.controls.name=a.controls.properties.legend,angular.forEach(a.controls.children,function(b,c){b.name=a.controls.name})}function l(a,f,g){var h=d.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(h)?h:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var i=b.getTabOptions(a.controls.properties.tabId);r(a,i),a.$watch("controls.value",function(b,f){if(b!==!0||f!==!1&&void 0!==f)b===!1&&f===!0&&(c.hasControl(a.controls.properties.id)&&c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0));else{var h={controlId:a.controls.properties.id,label:a.controls.name?a.controls.name:"",heirarchyLabels:a.controls.heirarchyLabels,type:a.controls.type,valueLabel:a.controls.properties.label,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};u(h),c.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,g.value=a.controls.value,t(h,i),e.setSpecifiClassificationDetails(h,i.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&i&&i.properties.inputPanelToUseInDiagnoseTab&&!i.properties.selectSpecificClassification&&s(i.properties.inputPanelToUseInDiagnoseTab)}})}function m(a,f){a.controls.value||(a.controls.value=0);var g=d.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(g)?g:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var h=b.getTabOptions(a.controls.properties.tabId);f.on("change",'input[type="number"]',function(){var b=parseInt($(this).val());if(!(0>=b)){a.controls.value=b;var f={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.value,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};u(f),c.addControl(a.controls.properties.id,f),t(f,h),e.setSpecifiClassificationDetails(f,h.properties),a.controls.showCategory=!0,!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&h&&h.properties.inputPanelToUseInDiagnoseTab&&!h.properties.selectSpecificClassification&&s(h.properties.inputPanelToUseInDiagnoseTab),a.$apply()}}),a.$watch("controls.value",function(a){$(f).find('input[type="number"]').val(a).slider().slider("refresh")}),r(a,h)}function n(a){var f=d.get("uniqueProperty");a.controls.uniqueProperty=f,a.controls.properties.id=f+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var g=b.getTabOptions(a.controls.properties.tabId);a.$watch("controls.value",function(b,f){if(void 0!==b&&""!==b){var h={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.value,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};u(h),c.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,t(h,g),e.setSpecifiClassificationDetails(h,g.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&g.properties.inputPanelToUseInDiagnoseTab&&!g.properties.selectSpecificClassification&&s(g.properties.inputPanelToUseInDiagnoseTab)}else c.hasControl(a.controls.properties.id)&&c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0)}),r(a,g)}function o(a){d.set("SliderCount",d.get("SliderCount")+1),void 0===a.controls.properties.id&&(a.controls.properties.id="ToggleSwitch"+d.get("SliderCount")),(void 0===a.controls.properties.label||""===a.controls.properties.label)&&(a.controls.properties.label=d.get("TextLabel")),d.set("TextLabel","");var f=d.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(f)?f:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var g=b.getTabOptions(a.controls.properties.tabId);a.controls.value="false",a.$watch("controls.value",function(b,f){if("true"===b&&"false"===f){var h={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.properties.label1,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren};u(h),c.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,t(h,g),e.setSpecifiClassificationDetails(h,g.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&g.properties.inputPanelToUseInDiagnoseTab&&!g.properties.selectSpecificClassification&&s(g.properties.inputPanelToUseInDiagnoseTab)}else"false"===b&&(c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0))}),r(a,g)}function p(a,f){d.set("SelectMenuCount",d.get("SelectMenuCount")+1),void 0===a.controls.properties.id&&(a.controls.properties.id="SelectMenu"+d.get("SelectMenuCount")),a.controls.labelPrefix=d.get("tabHierarchyHeadings"),a.controls.properties.options&&a.controls.properties.options.children&&(a.controls.previousValue=a.controls.value=a.controls.defaultValue=a.controls.properties.options.children[0].value,a.controls.previousValueLabel=a.controls.valueLabel=a.controls.defaultValueLabel=a.controls.properties.options.children[0].text);var g=b.getTabOptions(a.controls.properties.tabId);f.on("change","select.control",function(b){var f=$(this).val(),h=$('option[value="'+f+'"]:selected',$(this)).text();if(f!==a.controls.previousValue&&f!==a.controls.defaultValue||h!==a.controls.previousValueLabel&&h!==a.controls.defaultValueLabel){a.controls.previousValue=a.controls.value,a.controls.previousValueLabel=a.controls.valueLabel,a.controls.value=f,a.controls.valueLabel=h;var i={controlId:a.controls.properties.id,label:a.controls.properties.label||a.controls.properties.options.label,type:a.controls.type,valueLabel:a.controls.valueLabel,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren};u(i),c.addControl(a.controls.properties.id,i),a.controls.showCategory=!0,t(i,g),e.setSpecifiClassificationDetails(i,g.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&g.properties.inputPanelToUseInDiagnoseTab&&!g.properties.selectSpecificClassification&&s(g.properties.inputPanelToUseInDiagnoseTab)}else c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0);a.$digest()}),r(a,g)}function q(a){var b=a.controls,c=b.properties&&b.properties.rows?b.properties.rows:1;void 0===b.properties&&(b.properties={}),b.properties.uiClass=GridBuilder.getGridClass(b.children,c),GridBuilder.setGridControlLabels(b)}function r(a,b){if(a.controls.attachCategories&&b&&b.properties.inputPanelToUseInDiagnoseTab&&!a.controls.categorieschildren){var c=angular.copy(b.categories[0].categorieschildren);updateId(a.controls.properties.id,d.get("uniqueProperty"),c),d.get("ClassificationDataAdded").push({controlId:a.controls.properties.id,uniqueProperty:d.get("uniqueProperty"),classification:c}),a.controls.categorieschildren=c}}function s(a){var b="useClassificationPanel"===a?"leftpanel":"useRightPanel"===a?"rightpanel":"";$("#"+b).panel("open"),$("#closePanelButton").removeClass("ui-btn-active")}function t(a,b){b&&"useClassificationPanel"===b.properties.inputPanelToUseInDiagnoseTab?d.setRecentlySelectedControlDetails(a):b&&"useRightPanel"===b.properties.inputPanelToUseInDiagnoseTab&&f.setPanelData("right",a)}function u(a){var b=(a.labelPrefix?a.labelPrefix:"")+(a.label?(a.labelPrefix?" : ":"")+a.label:"")+(a.heirarchyLabels&&a.heirarchyLabels.length>0?" : "+a.heirarchyLabels.join(" : "):"");a.controlLabel=b}var v={};return v.processHierarchyLabelsForContainer=g,v.processHierarchyLabelsForControl=i,v.processRadioGroup=j,v.processCheckboxGroup=k,v.processCheckbox=l,v.processSlider=m,v.processTextInput=n,v.processToggleSwitch=o,v.processSelectMenu=p,v.processGrid=q,v.openPanel=s,v}angular.module("controls-module").service("DirectiveHelperService",a),a.$inject=["ControlsService","TabOptionsDataService","SelectedControlsService","SharedDataService","specificClassificationService","panelDataService"]}();
