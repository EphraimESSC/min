...
/* Min file (c) */
"use strict";!function(){angular.module("config-module.diagnose-config",["diagnose-module.data-transfer","controls-module","db-module","categorization-module"])}();
...
/* Min file (c) */
"use strict";!function(){function a(a,b,c,d,e,f){function g(){var d=c.getServiceValues();return a.getValue("DiagnoseConfigDataServiceValues").then(function(a){a&&a.tabInfo&&(b.scanAndUpdateDuplicateIds(a.tabInfo),q.tabInfo=a.tabInfo,q.tabInfo.length>0&&angular.forEach(q.tabInfo[0].children,function(a,b){a.selectedList&&angular.forEach(d.lists,function(b,c){return b.listName===a.selectedList.listName?(a.selectedList=d.lists[c],!1):void 0}),a.categoriesList&&angular.forEach(d.lists,function(b,c){return b.listName===a.categoriesList.listName?(a.categoriesList=d.lists[c],!1):void 0})}))}),d}function h(){$("#diagnoseConfigLoader").loader().loader("show"),a.setValue("DiagnoseConfigDataServiceValues",q).then(function(a){$("#diagnoseConfigLoader").loader("hide")})}function i(){return q}function j(a,c,d){if(q.tabInfo[0].children[d]){q.tabInfo[0].children[d].fileName=a,q.tabInfo[0].children[d].children&&b.removeIdsFromCacheList(q.tabInfo[0].children[d].children);try{var e=JSON.parse(c);b.scanAndUpdateDuplicateIds(e),q.tabInfo[0].children[d].children=e}catch(f){}}}function k(){var a={properties:{label:"Diagnose Tab "+(q.tabInfo[0].children.length+1),id:b.generateUniqueId()},type:"Tabs"};q.tabInfo[0].children.push(a)}function l(){p.persistValues();var a=b.scanAndUpdateDuplicateIds(angular.copy(q.tabInfo));d.setControls(a),angular.forEach(a[0].children,function(a,b){e.setTabOptions(a.properties.id,a)}),ConfigTabFunctionality.setAppRefreshPending()}function m(a){q.tabInfo[0].children[a].children=q.tabInfo[0].children[a].selectedList.controls}function n(a){var b=q.tabInfo[0].children[a].categoriesList.controls;q.tabInfo[0].children[a].categories=b;var c=q.tabInfo[0].children[a].categories,d=[];f.constructFinalCategorizationArrays(c[0],d),q.tabInfo[0].children[a].categoriesListArray=d}function o(a){b.removeIdsFromCacheList(q.tabInfo[0].children[a]),b.removeIdsFromCacheList(q.tabInfo[0].children[a].categories,"categorieschildren"),q.tabInfo[0].children.splice(a,1);var c=d.getControls();c[0].children.splice(a,1),d.setControls(c)}var p={},q={tabInfo:[{properties:{id:"rootId"},type:"TabRoot",children:[]}]};return p.initialize=g,p.persistValues=h,p.getValues=i,p.loadFileAsControls=j,p.addDiagnoseTab=k,p.saveDiagnoseConfig=l,p.changeDiagnoseList=m,p.categoryChanged=n,p.deleteDiagnoseTab=o,p}angular.module("config-module.diagnose-config").service("DiagnoseConfigDataService",a),a.$inject=["DBService","IdentityService","ControlsService","DiagnoseDataTransferService","TabOptionsDataService","categorizationService"]}();
//# sourceMappingURL=DiagnoseConfigDataService.js.map
/* Min file (c) */
!function(){function a(a){return{restrict:"E",templateUrl:"AppCode/DiagnoseConfig/DiagnoseConfigTemplate.html",link:function(b,c,d){a(function(){$(c).enhanceWithin(),console.log("enhanced",c)},8e3)}}}angular.module("config-module.diagnose-config").directive("diagnoseConfig",a),a.$inject=["$timeout"]}();
...
/* Min file (c) */
!function(){function a(a,b,c,d,e){function f(a,b){a.heirarchyLabels||(a.heirarchyLabels=[]),a.heirarchyLabels=(angular.isDefined(b)&&angular.isDefined(b.heirarchyLabels)?angular.copy(b.heirarchyLabels):[]).concat(a.heirarchyLabels);var c=g(a);c&&a.heirarchyLabels.push(c)}function g(a){return"Collapsible"===a.type&&a.properties.heading?a.properties.heading:"CheckboxGroup"===a.type&&a.name?a.name:void 0}function h(a,b){angular.isUndefined(b)||(a.heirarchyLabels=b.heirarchyLabels?angular.copy(b.heirarchyLabels):[])}function i(a){d.set("RadioGroupCount",d.get("RadioGroupCount")+1),a.controls.groupname="RadioGroup"+d.get("RadioGroupCount"),a.controls.labelPrefix=d.get("tabHierarchyHeadings"),a.controls.name=a.controls.properties.legend,void 0===a.controls.properties.id&&(a.controls.properties.id="RadioGroup"+d.get("RadioGroupCount"));var c=b.getTabOptions(a.controls.properties.tabId);a.$watch("controls.value",function(b,f){if(void 0!==b){var g={controlId:a.controls.properties.id,label:a.controls.labelPrefix+a.controls.properties.legend,heirarchyLabels:a.controls.heirarchyLabels,type:a.controls.type,valueLabel:a.controls.value,value:a.controls.value,labelPrefix:a.controls.labelPrefix,categoriesInfo:a.controls.categorieschildren,control:a.controls};s(g),d.get("SelectedControls")[a.controls.properties.id]=g,a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(g),e.setSpecifiClassificationDetails(g,c.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&c&&c.properties.useClassificationPanelInput&&!c.properties.selectSpecificClassification&&r()}else delete d.get("SelectedControls")[a.controls.properties.id],a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0)}),q(a,c)}function j(a){a.controls.name=a.controls.properties.legend,angular.forEach(a.controls.children,function(b,c){b.name=a.controls.name})}function k(a,f){var g=d.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(g)?g:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var h=b.getTabOptions(a.controls.properties.tabId);q(a,h),a.$watch("controls.value",function(b,f){if(b!==!0||f!==!1&&void 0!==f)b===!1&&f===!0&&(c.hasControl(a.controls.properties.id)&&c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0));else{var g={controlId:a.controls.properties.id,label:a.controls.name?a.controls.name:"",heirarchyLabels:a.controls.heirarchyLabels,type:a.controls.type,valueLabel:a.controls.properties.label,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};s(g),c.addControl(a.controls.properties.id,g),a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(g),e.setSpecifiClassificationDetails(g,h.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&h&&h.properties.useClassificationPanelInput&&!h.properties.selectSpecificClassification&&r()}})}function l(a,f){a.controls.value||(a.controls.value=0);var g=d.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(g)?g:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var h=b.getTabOptions(a.controls.properties.tabId);f.on("change",'input[type="number"]',function(){var b=parseInt($(this).val());if(!(0>=b)){a.controls.value=b;var f={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.value,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};s(f),c.addControl(a.controls.properties.id,f),d.setRecentlySelectedControlDetails(f),e.setSpecifiClassificationDetails(f,h.properties),a.controls.showCategory=!0,!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&h&&h.properties.useClassificationPanelInput&&!h.properties.selectSpecificClassification&&r(),a.$apply()}}),a.$watch("controls.value",function(a){$(f).find('input[type="number"]').val(a).slider().slider("refresh")}),q(a,h)}function m(a){var f=d.get("uniqueProperty");a.controls.uniqueProperty=f,a.controls.properties.id=f+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var g=b.getTabOptions(a.controls.properties.tabId);a.$watch("controls.value",function(b,f){if(void 0!==b&&""!==b){var h={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.value,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};s(h),c.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(h),e.setSpecifiClassificationDetails(h,g.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&g.properties.useClassificationPanelInput&&!g.properties.selectSpecificClassification&&r()}else c.hasControl(a.controls.properties.id)&&c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0)}),q(a,g)}function n(a){d.set("SliderCount",d.get("SliderCount")+1),void 0===a.controls.properties.id&&(a.controls.properties.id="ToggleSwitch"+d.get("SliderCount")),(void 0===a.controls.properties.label||""===a.controls.properties.label)&&(a.controls.properties.label=d.get("TextLabel")),d.set("TextLabel","");var f=d.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(f)?f:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var g=b.getTabOptions(a.controls.properties.tabId);a.controls.value="false",a.$watch("controls.value",function(b,f){if("true"===b&&"false"===f){var h={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.properties.label1,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren};s(h),c.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(h),e.setSpecifiClassificationDetails(h,g.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&g.properties.useClassificationPanelInput&&!g.properties.selectSpecificClassification&&r()}else"false"===b&&(c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0))}),q(a,g)}function o(a,f){d.set("SelectMenuCount",d.get("SelectMenuCount")+1),void 0===a.controls.properties.id&&(a.controls.properties.id="SelectMenu"+d.get("SelectMenuCount")),a.controls.labelPrefix=d.get("tabHierarchyHeadings"),a.controls.properties.options&&a.controls.properties.options.children&&(a.controls.previousValue=a.controls.value=a.controls.defaultValue=a.controls.properties.options.children[0].value,a.controls.previousValueLabel=a.controls.valueLabel=a.controls.defaultValueLabel=a.controls.properties.options.children[0].text);var g=b.getTabOptions(a.controls.properties.tabId);f.on("change","select.control",function(b){var f=$(this).val(),h=$('option[value="'+f+'"]:selected',$(this)).text();if(f!==a.controls.previousValue&&f!==a.controls.defaultValue||h!==a.controls.previousValueLabel&&h!==a.controls.defaultValueLabel){a.controls.previousValue=a.controls.value,a.controls.previousValueLabel=a.controls.valueLabel,a.controls.value=f,a.controls.valueLabel=h;var i={controlId:a.controls.properties.id,label:a.controls.properties.label||a.controls.properties.options.label,type:a.controls.type,valueLabel:a.controls.valueLabel,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren};s(i),c.addControl(a.controls.properties.id,i),a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(i),e.setSpecifiClassificationDetails(i,g.properties),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&g.properties.useClassificationPanelInput&&!g.properties.selectSpecificClassification&&r()}else c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0);a.$digest()}),q(a,g)}function p(a){var b=a.controls,c=b.properties&&b.properties.rows?b.properties.rows:1;void 0===b.properties&&(b.properties={}),b.properties.uiClass=GridBuilder.getGridClass(b.children,c),GridBuilder.setGridControlLabels(b)}function q(a,b){if(a.controls.attachCategories&&b&&b.properties.useClassificationPanelInput&&!a.controls.categorieschildren){var c=angular.copy(b.categoriesList.controls[0].categorieschildren);updateId(a.controls.properties.id,d.get("uniqueProperty"),c),d.get("ClassificationDataAdded").push({controlId:a.controls.properties.id,uniqueProperty:d.get("uniqueProperty"),classification:c}),a.controls.categorieschildren=c}}function r(){$("#leftpanel").panel("open"),$("#closePanelButton").removeClass("ui-btn-active")}function s(a){var b=(a.labelPrefix?a.labelPrefix:"")+(a.label?(a.labelPrefix?" : ":"")+a.label:"")+(a.heirarchyLabels&&a.heirarchyLabels.length>0?" : "+a.heirarchyLabels.join(" : "):"");a.controlLabel=b}var t={};return t.processHierarchyLabelsForContainer=f,t.processHierarchyLabelsForControl=h,t.processRadioGroup=i,t.processCheckboxGroup=j,t.processCheckbox=k,t.processSlider=l,t.processTextInput=m,t.processToggleSwitch=n,t.processSelectMenu=o,t.processGrid=p,t}angular.module("controls-module").service("DirectiveHelperService",a),a.$inject=["ControlsService","TabOptionsDataService","SelectedControlsService","SharedDataService","specificClassificationService"]}();
...
/* Min file (c) */
!function(){function a(){var a={restrict:"AE",transclude:!0,templateUrl:"Components/JqmComponentsModule/jqm-components.jqm-collapsible.template.html",scope:{title:"@"},link:function(a,b,c){a.showContent=!1,b.find(".ui-collapsible-heading a").on("click",function(){a.showContent=!a.showContent,a.$digest()})}};return a}angular.module("jqm-components-module").directive("jqmCollapsible",a)}();
...
/* Min file (c) */
!function(){function a(){var a={restrict:"AE",transclude:!0,templateUrl:"Components/JqmComponentsModule/jqm-components.jqm-checkbox.template.html",scope:{id:"@",model:"=",checked:"@"},link:function(a,b,c){angular.isUndefined(a.checked)&&(a.checked=!1),angular.isDefined(c.first)&&b.find("label").addClass("ui-first-child"),angular.isDefined(c.last)&&b.find("label").addClass("ui-last-child"),b.find("label").on("click",function(){a.checked=!a.checked})}};return a}angular.module("jqm-components-module").directive("jqmCheckbox",a)}();
