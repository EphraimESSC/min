...
/* Min file (c) */
!function(){"use strict";angular.module("ui").directive("enhanceUi",[function(){return{restrict:"A",link:function(a,b,c){b.enhanceWithin(),b.closest("[enhance-ui-parent]").enhanceWithin()}}}])}();
...
/* Min file (c) */
!function(){function a(){}var b;try{b=angular.module("client-module")}catch(c){b=angular.module("client-module",["diagnose-module.data-transfer","db-module"])}b.controller("ClientController",a)}();
...
/* Min file (c) */
"use strict";!function(){function a(a,b,c){function d(){var a=c.getValue("ClientDataServiceValues");a&&(w.clientsData.push.apply(w.clientsData,a.clientsData),w.nextClientId=a.nextClientId)}function e(){return w}function f(){if(""===w.selectedClient.clientName)return-1;var a={clientId:w.nextClientId,clientName:w.selectedClient.clientName,clientAge:w.selectedClient.clientAge,birthdateAndHour:w.selectedClient.birthdateAndHour,clientGender:w.selectedClient.clientGender,clientPhone:w.selectedClient.clientPhone,clientAddress:w.selectedClient.clientAddress,nextDiagnoseId:1,diagnoseData:[]};return w.clientsData.push(a),w.nextClientId++,c.setValue("ClientDataServiceValues",w),w.selectedClient.clientName="",w.selectedClient.clientAge="",w.selectedClient.birthdateAndHour="",w.selectedClient.clientGender="",w.selectedClient.clientPhone="",w.selectedClient.clientAddress="",w.clientsData.length}function g(a){w.clientsData.splice(a,1),c.setValue("ClientDataServiceValues",w)}function h(a){var b=_.find(w.clientsData,function(b){return b.clientId===a});return b}function i(a){b.addDiagnoseAction(a).then(function(b){u.addDiagnose(a,b.selectedControlsDetails,b.imageCollectionHolder)})}function j(a,b,d){var e=u.prepareCategorizationArray(b),f=h(a),g="Diagnose: "+f.nextDiagnoseId+", "+(new Date).toLocaleString(),i={diagnoseId:f.nextDiagnoseId,diagnoseName:g,selectedControlsDetails:b,categoriesArray:e,imageCollectionHolder:d};f.nextDiagnoseId++,f.diagnoseData.push(i),c.setValue("ClientDataServiceValues",w)}function k(a,c){var d=u.getClientDiagnose(a,c);b.editDiagnoseAction(a,c,d.selectedControlsDetails,d.imageCollectionHolder).then(function(b){u.editDiagnose(a,c,b.selectedControlsDetails,b.imageCollectionHolder)})}function l(a,b,d,e){var f=h(a),g=f.diagnoseData[b];g.selectedControlsDetails=d,g.imageCollectionHolder=e,g.categoriesArray=u.prepareCategorizationArray(d),c.setValue("ClientDataServiceValues",w)}function m(a,c){var d=u.getClientDiagnose(a,c);b.classifyDiagnoseAction(a,c,d.selectedControlsDetails,d.imageCollectionHolder).then(function(b){u.classifyDiagnose(a,c,b.selectedControlsDetails)})}function n(a,b,d){var e=h(a),f=e.diagnoseData[b];p(d),f.selectedControlsDetails=d,f.categoriesArray=u.prepareCategorizationArray(d),c.setValue("ClientDataServiceValues",w)}function o(a){var b={};angular.forEach(a,function(a,c){a.finalCategorizationArrays&&a.finalCategorizationArrays.length>0?angular.forEach(a.finalCategorizationArrays,function(c){if(c&&c.length>0){var d=_.deepPluck(c,"properties.label"),e=d.join(" : ");b[e]||(b[e]=[]),b[e].push(a)}}):(b.Unclassified||(b.Unclassified=[]),b.Unclassified.push(a))});var c=[];return angular.forEach(b,function(a,b){c.push({text:b,title:!0}),angular.forEach(a,function(a){c.push({text:a.controlLabel+" : "+a.valueLabel,title:!1})})}),c}function p(a){angular.forEach(a,function(a,b){a.finalCategorizationArrays=[],a.categoriesIdsArray=[];var c=a.categoriesInfo;angular.forEach(c,function(b,c){if(b.properties.value===!0){var d=[];q(b,d,a)}})})}function q(a,b,c){if(a&&a.properties.value){if(c.categoriesIdsArray.push(a.properties.id),b.push(a),void 0===a.categorieschildren)return c.finalCategorizationArrays.push(angular.copy(b)),void b.splice(b.length-1,1);var d=!1;if(angular.forEach(a.categorieschildren,function(a,b){a.properties.value&&(d=!0)}),!d)return c.finalCategorizationArrays.push(angular.copy(b)),void b.splice(b.length-1,1);angular.forEach(a.categorieschildren,function(a,d){q(a,b,c)})}}function r(a,b){var c=h(a),d=c.diagnoseData[b];return d}function s(a,b){var d=h(a);d.diagnoseData.splice(b,1),c.setValue("ClientDataServiceValues",w)}function t(a){if(a||(a=w.filterText),"*"===a)return w.filteredData.splice(0,w.filteredData.length),w.filteredData.push.apply(w.filteredData,w.clientsData),w.filteredData;if(""===a)return w.filteredData.splice(0,w.filteredData.length),w.filteredData;var b=_.filter(w.clientsData,function(b){return-1!==b.clientName.search(a)});return w.filteredData.splice(0,w.filteredData.length),w.filteredData.push.apply(w.filteredData,b),w.filteredData}var u={},v={clientId:-1,clientName:"",clientAge:"",birthdateAndHour:"",clientGender:"",clientPhone:"",clientAddress:"",clientEmail:""},w={selectedClient:v,clientsData:[],nextClientId:0,filterText:"",filteredData:[]};return u.initialize=d,d(),u.getValues=e,u.addClient=f,u.deleteClient=g,u.getClientById=h,u.addDiagnoseAction=i,u.addDiagnose=j,u.editDiagnoseAction=k,u.editDiagnose=l,u.classifyDiagnoseAction=m,u.classifyDiagnose=n,u.prepareCategorizationArray=o,u.getClientDiagnose=r,u.deleteDiagnose=s,u.filter=t,u}angular.module("client-module").service("ClientDataService",a),a.$inject=["DiagnoseDataTransferService","ClientDiagnoseDataService","LocalStorageService"]}();
...
/* Min file (c) */
!function(){function a(){var a={restrict:"E",templateUrl:"AppCode/ClientModule/ClientAppointmentsTemplate.html",link:function(a,b,c){}};return a}var b;try{b=angular.module("client-module")}catch(c){b=angular.module("client-module",["diagnose-module.data-transfer","db-module"])}b.directive("clientAppointments",a)}();
//# sourceMappingURL=ClientAppointmentsDirective.js.map
/* Min file (c) */
"use strict";!function(){function a(a,b,c){function d(){return m}function e(){a.getValue("ClientDiagnoseDataServiceValues").then(function(a){a&&angular.forEach(a,function(a,b){m[b]=a})})}function f(a){return m[a]}function g(b,c){m[b]=c,a.setValue("ClientDiagnoseDataServiceValues",m)}function h(a){m.clientId=a}function i(a){var d=m.defer=c.defer(),e={actionTrackerInfo:{clientId:a}};return b.$emit("ClientDiagnoseDataService.addDiagnoseAction",e),DiagnoseTabFunctionality.makeActive(),d.promise}function j(a,d,e,f){var g=m.defer=c.defer(),h={selectedControlsDetails:e,imageCollectionHolder:f,actionTrackerInfo:{clientId:a,diagnoseIndex:d}};return b.$emit("ClientDiagnoseDataService.editDiagnoseAction",h),DiagnoseTabFunctionality.makeActive(),g.promise}function k(a,d,e,f){var g=m.defer=c.defer(),h={selectedControlsDetails:e,imageCollectionHolder:f,actionTrackerInfo:{clientId:a,diagnoseIndex:d}};return b.$emit("client-module.classify-module.classifyDiagnoseAction",h),ClassifyTabFunctionality.makeActive(),g.promise}var l={},m={};return l.getValues=d,l.initialize=e,l.getClientDiagnose=f,l.setClientDiagnose=g,l.setClientId=h,b.$on("DiagnoseDataService.saveClientDiagnose",function(a,b){m.defer.resolve(b),m.defer=null}),b.$on("classify-module.client-module.saveClientDiagnose",function(a,b){m.defer.resolve(b),m.defer=null}),l.addDiagnoseAction=i,l.editDiagnoseAction=j,l.classifyDiagnoseAction=k,l}angular.module("client-module").service("ClientDiagnoseDataService",a),a.$inject=["DBService","$rootScope","$q"]}();
//# sourceMappingURL=ClientDiagnoseDataService.js.map
/* Min file (c) */
!function(){function a(){var a={restrict:"E",templateUrl:"AppCode/ClientModule/PersonalDetailsTemplate.html"};return a}angular.module("client-module").directive("personalDetails",a)}();
//# sourceMappingURL=PersonalDetailsDirective.js.map
/* Min file (c) */
"use strict";!function(){function a(a){var c={restrict:"E",templateUrl:"AppCode/ClientModule/DiagnoseDetailsTemplate.html",scope:{diagnoseData:"=",clientId:"="},link:function(b,c,d){a(function(){$(c).enhanceWithin()},1),b.$watch("diagnoseData",function(){a(function(){$(c).enhanceWithin()},1)},!0)},controller:b};return c}function b(a,b,c){a.onEditDiagnose=function(c){b.editDiagnoseAction(a.clientId,c)},a.onClassifyDiagnose=function(c){b.classifyDiagnoseAction(a.clientId,c)},a.onDeleteDiagnose=function(c){b.deleteDiagnose(a.clientId,c)}}angular.module("client-module").directive("diagnoseDetails",a).controller("DiagnoseDetailsController",b),a.$inject=["$timeout"],b.$inject=["$scope","ClientDataService","ClientDiagnoseDataService"]}();
//# sourceMappingURL=DiagnoseDetailsDirective.js.map
/* Min file (c) */
!function(){"use strict";function a(a,b,c,d,e,f){var g=this,h=g.model={};g.initialize=function(){b.initialize(),h.serviceValues=b.getValues()},g.initialize(),e.$on("ClientDiagnoseDataService.editDiagnoseAction",function(b,d){console.log("ClientDiagnoseDataService.editDiagnoseAction",b,d);{var e=d.selectedControlsDetails;d.imageCollectionHolder}c.setIsControlsValuesBeingSet(!0),a.setIsAddDiagnose(!1),a.setActionTrackerInfo(d.actionTrackerInfo),a.setControlsValues(e);var g=0,h=!1,i=f.$watch(function(){h||(h=!0,f.$$postDigest(function(){h=!1,g++<1?setTimeout(function(){FunctionalityModule.enhancePage()},1):(i(),c.setIsControlsValuesBeingSet(!1))}))})}),e.$on("ClientDiagnoseDataService.addDiagnoseAction",function(b,c){console.log("ClientDiagnoseDataService.addDiagnoseAction",b,c),a.setIsAddDiagnose(!0),a.setActionTrackerInfo(c.actionTrackerInfo)}),g.onSaveDiagnoseItemsData=function(){var b=d.getSelectedControls();a.processSelectedControls(b),ClientTabFunctionality.makeActive(),DiagnoseTabFunctionality.makeInactive()}}angular.module("diagnose-module",["diagnose-module.data-transfer","selected-controls-module","data"]).controller("DiagnoseController",a),a.$inject=["DiagnoseDataService","DiagnoseDataTransferService","SharedDataService","SelectedControlsService","$rootScope","$scope"]}();
//# sourceMappingURL=DiagnoseController.js.map
/* Min file (c) */
"use strict";!function(){function a(a,b,c,d){function e(){return t}function f(a){t.isAddDiagnose=a}function g(a){t.actionTrackerInfo=a}function h(){0==t.isAddDiagnose&&(t.isAddDiagnose=!0)}function i(b){j(b);var c,e=a.getControls();e&&(c=s.constructImageCollectionHolder(e)),d.$emit("DiagnoseDataService.saveClientDiagnose",{selectedControlsDetails:angular.copy(b),imageCollectionHolder:c,isAddDiagnose:t.isAddDiagnose,actionTrackerInfo:t.actionTrackerInfo}),t.actionTrackerInfo=null,h(),s.resetControls(b),s.resetCategories(b)}function j(a){angular.forEach(a,function(a,b){a.finalCategorizationArrays=[],a.categoriesIdsArray=[];var c=a.categoriesInfo;angular.forEach(c,function(b,c){if(b.properties.value===!0){var d=[];k(b,d,a)}})})}function k(a,b,c){if(a&&a.properties.value){if(c.categoriesIdsArray.push(a.properties.id),b.push(a),void 0===a.categorieschildren)return c.finalCategorizationArrays.push(angular.copy(b)),void b.splice(b.length-1,1);var d=!1;if(angular.forEach(a.categorieschildren,function(a,b){a.properties.value&&(d=!0)}),!d)return c.finalCategorizationArrays.push(angular.copy(b)),void b.splice(b.length-1,1);angular.forEach(a.categorieschildren,function(a,d){k(a,b,c)})}}function l(a){var b=[];return angular.forEach(a[0].children,function(a,c){"useAsWebCamTab"===a.diagnoseTabChoice&&a.imageValues.imagesCollection&&b.push(angular.copy(a.imageValues.imagesCollection))}),b}function m(b){var d=a.getControls();angular.forEach(b,function(a,b){var c=n(d,b);c.value=a.value,angular.forEach(a.categoriesIdsArray,function(a,b){var d=o(c.categorieschildren,a);d.properties.value=!0})}),c.setSelectedControls(b)}function n(a,b){for(var c=0;c<a.length;c++){var d=a[c];if(d.properties.id===b)return d;if(d.children){var e=n(d.children,b);if(e)return e}}}function o(a,b){for(var c=0;c<a.length;c++){var d=a[c];if(d.properties.id===b)return d;if(d.categorieschildren){var e=o(d.categorieschildren,b);if(e)return e}}}function p(a){angular.forEach(a,function(a,b){a.value=!1,a.control&&angular.isDefined(a.control.value)&&(a.control.value=!1)})}function q(a){angular.forEach(a,function(a,b){var c=a.categoriesInfo;angular.forEach(c,function(a,b){r(a)})})}function r(a){a&&a.properties.value===!0&&(a.properties.value=!1,void 0!==a.categorieschildren&&angular.forEach(a.categorieschildren,function(a,b){r(a)}))}var s={},t={isAddDiagnose:!0,actionTrackerInfo:null};return s.getValues=e,s.setIsAddDiagnose=f,s.setActionTrackerInfo=g,s.processSelectedControls=i,s.constructImageCollectionHolder=l,s.setControlsValues=m,s.fetchCategory=o,s.resetControls=p,s.resetCategories=q,s}angular.module("diagnose-module").service("DiagnoseDataService",a),a.$inject=["DiagnoseDataTransferService","SharedDataService","SelectedControlsService","$rootScope"]}();
//# sourceMappingURL=DiagnoseDataService.js.map
/* Min file (c) */
"use strict";!function(){function a(a){function b(){a.getValue("DiagnoseDataTransferService").then(function(a){a&&(g.controls=a.controls)})}function c(){return g.controls}function d(a){g.controls=a,e()}function e(){a.setValue("DiagnoseDataTransferService",g)}function f(){return g}var g={controls:null};this.initialize=b,this.getControls=c,this.setControls=d,this.persistData=e,this.getValues=f}angular.module("diagnose-module.data-transfer",["db-module"]).service("DiagnoseDataTransferService",a),a.$inject=["DBService"]}();
...
/* Min file (c) */
"use strict";!function(){function a(a){var b={restrict:"AE",templateUrl:"AppCode/ClassifyModule/ClassifyDiagnoseTemplate.html",controller:"ClassifyDiagnoseController",controllerAs:"classifyDiagnoseController",link:function(b,c,d){a(function(){c.enhanceWithin()},1)}};return b}function b(a){var b=this,c=b.model={selectedControlsDetails:{},actionTrackerInfo:{}};a.$on("client-module.classify-module.classifyDiagnoseAction",function(a,b){c.selectedControlsDetails=b.selectedControlsDetails,c.actionTrackerInfo=b.actionTrackerInfo}),b.onSaveClassificationInfo=function(){var b={selectedControlsDetails:angular.copy(c.selectedControlsDetails),actionTrackerInfo:c.actionTrackerInfo};a.$emit("classify-module.client-module.saveClientDiagnose",b),ClientTabFunctionality.makeActive(),ClassifyTabFunctionality.makeInactive()}}angular.module("classify-module").controller("ClassifyDiagnoseController",b).directive("classifyDiagnose",a),a.$inject=["$timeout"],b.$inject=["$rootScope"]}();
//# sourceMappingURL=ClassifyDiagnoseDirective.js.map
/* Min file (c) */
"use strict";!function(){function a(){return function(a,b,c){return _.filter(a,function(a){return a[b]===c})}}function b(a){function b(){e.serviceValues=a.getValues(),e.controlsServiceValues=a.initialize()}function c(b,c){function d(d){var e=b.files[0].name,f=d.target.result;a.loadFileAsControls(e,f,c)}var e="",f="";a.loadFileAsControls(e,f,c);var g=new FileReader;g.addEventListener("load",d),g.readAsText(b.files[0])}var d=this,e=d.model={};d.initialize=b,b(),d.onFileInput=c,d.onAddDiagnoseTab=function(){a.addDiagnoseTab(),setTimeout(function(){$("#defaultPage").enhanceWithin()},1)},d.onSaveDiagnoseConfig=function(){a.saveDiagnoseConfig()},d.onChangeCategories=function(b){a.categoryChanged(b)},d.onChangeDiagnoseList=function(b){a.changeDiagnoseList(b)},d.onDeleteDiagnoseTab=function(b){a.deleteDiagnoseTab(b)}}angular.module("config-module.diagnose-config",["diagnose-module.data-transfer","controls-module","db-module"]).filter("property",a).controller("DiagnoseConfigController",b),b.$inject=["DiagnoseConfigDataService"]}();
//# sourceMappingURL=DiagnoseConfigController.js.map
/* Min file (c) */
"use strict";!function(){function a(a,b,c,d,e){function f(){var d=c.getServiceValues();return a.getValue("DiagnoseConfigDataServiceValues").then(function(a){a&&a.tabInfo&&(b.scanAndUpdateDuplicateIds(a.tabInfo),p.tabInfo=a.tabInfo,p.tabInfo.length>0&&angular.forEach(p.tabInfo[0].children,function(a,b){a.selectedList&&angular.forEach(d.lists,function(b,c){return b.listName===a.selectedList.listName?(a.selectedList=d.lists[c],!1):void 0}),a.categoriesList&&angular.forEach(d.lists,function(b,c){return b.listName===a.categoriesList.listName?(a.categoriesList=d.lists[c],!1):void 0})}))}),d}function g(){a.setValue("DiagnoseConfigDataServiceValues",p)}function h(){return p}function i(a,c,d){if(p.tabInfo[0].children[d]){p.tabInfo[0].children[d].fileName=a,p.tabInfo[0].children[d].children&&b.removeIdsFromCacheList(p.tabInfo[0].children[d].children);try{var e=JSON.parse(c);b.scanAndUpdateDuplicateIds(e),p.tabInfo[0].children[d].children=e}catch(f){}}}function j(){var a={properties:{label:"Diagnose Tab "+(p.tabInfo[0].children.length+1),id:b.generateUniqueId()},type:"Tabs"};p.tabInfo[0].children.push(a)}function k(){o.persistValues();var a=b.scanAndUpdateDuplicateIds(angular.copy(p.tabInfo));d.setControls(a),angular.forEach(a[0].children,function(a,b){e.setTabOptions(a.properties.id,a)}),ConfigTabFunctionality.setAppRefreshPending()}function l(a){p.tabInfo[0].children[a].children=p.tabInfo[0].children[a].selectedList.controls}function m(a){var b=p.tabInfo[0].children[a].categoriesList.controls;p.tabInfo[0].children[a].categories=b;var c=[];_.deepMapValues(b,function(a,b){"label"===b[b.length-1]&&c.push(a)}),p.tabInfo[0].children[a].categoriesListArray=c}function n(a){b.removeIdsFromCacheList(p.tabInfo[0].children[a]),b.removeIdsFromCacheList(p.tabInfo[0].children[a].categories,"categorieschildren"),p.tabInfo[0].children.splice(a,1);var c=d.getControls();c[0].children.splice(a,1),d.setControls(c)}var o={},p={tabInfo:[{properties:{id:"rootId"},type:"TabRoot",children:[]}]};return o.initialize=f,o.persistValues=g,o.getValues=h,o.loadFileAsControls=i,o.addDiagnoseTab=j,o.saveDiagnoseConfig=k,o.changeDiagnoseList=l,o.categoryChanged=m,o.deleteDiagnoseTab=n,o}angular.module("config-module.diagnose-config").service("DiagnoseConfigDataService",a),a.$inject=["DBService","IdentityService","ControlsService","DiagnoseDataTransferService","TabOptionsDataService"]}();
//# sourceMappingURL=DiagnoseConfigDataService.js.map
/* Min file (c) */
!function(){function a(){return{restrict:"E",templateUrl:"AppCode/DiagnoseConfig/DiagnoseConfigTemplate.html",link:function(a,b,c){setTimeout(function(){b.enhanceWithin()},1e3)}}}angular.module("config-module.diagnose-config").directive("diagnoseConfig",a)}();
//# sourceMappingURL=DiagnoseConfigDirective.js.map
/* Min file (c) */
!function(){function a(){var a={restrict:"E",templateUrl:"AppCode/DiagnoseConfig/TabOptionsTemplate.html",replace:!0};return a}angular.module("config-module.diagnose-config").directive("tabOptions",a)}();
...
(function () {
  angular.module('controls-module', ['selected-controls-module', 'db-module']);
}());
...
/* Min file (c) */
!function(){function a(a,b,c,d,e){function f(){d.getValue(D).then(function(a){return a&&a.error?void console.log("Error in reading Control service values from DB",a.error):(void 0===a?d.setValue(D,G).then(function(a){return a&&a.error?void console.log("Error in setting Control service values in DB",a.error):void F.resolve()}):(G.lists=a.lists,F.resolve()),$("#listNameInput").focus(),$("#listItemNameInput").focus(),void b(function(){$("#defaultPage").enhanceWithin()},100))})}function g(a,b,c){if(angular.isUndefined(b)&&(b=B),angular.isUndefined(c)&&(c="diagnose"),"categories"===c&&(b.type="CategoriesButtonsStems"),-1!==_.pluck(G.lists,"listName").indexOf(a))return-1;var d={};d.listName=a,d.controls=[b],d.section=c,G.lists.push(d),k()}function h(a){a=a?a:0,a<G.lists.length&&(G.selected.list=G.lists[a],G.selected.listIndex=a,k("selected"))}function i(a){G.selected.list.listName=a,G.lists[G.selected.listIndex].listName=a,k("selected"),k("lists")}function j(){return G.selected.list}function k(a){var b;void 0===b&&(b=D);var c=["controls","lists","selected","allListNames"];F.promise.then(function(){$.indexedDB(C).objectStore(E).get(b).then(function(d){var e=d;void 0!==a?d[a]=G[a]:angular.forEach(c,function(a,b){d[a]=G[a]}),$.indexedDB(C).objectStore(E).put(e,b).then(function(){$.indexedDB(C).objectStore(E).get(b).then(function(a){},function(a,b){console.log("Could not get back updated data")})},function(a,b){console.log("Could not update data")})},function(a,c){console.log("Could not select by key:",b)})})}function l(){return G.controls}function m(){return G.selected}function n(a){return J[a]}function o(a,b){var c=J[b];angular.isUndefined(a[c])&&(a[c]=[])}function p(a,b){var c={properties:{id:"newItem"+e.generateUniqueId()},type:b},d=J[a];return c[d]=[],c}function q(a,b,d,e){o(a,e);var f=p(e,d);switch(f.fieldsInfo=c.generate(d,f.properties),null!==f.fieldsInfo&&(f=$.extend(!0,{},c.getStructure(),f)),d){case"Checkbox":case"RadioButton":case"Slider":case"TextInput":case"Tabs":case"Option":f.properties.label=b;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.label"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}break;case"CheckboxGroup":case"RadioGroup":f.properties.legend=b;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.legend"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}break;case"Text":f.properties.text=b;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.text"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}break;case"Collapsible":f.properties.heading=b;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.heading"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}break;default:if(f.properties.label=b,null!==f.fieldsInfo&&angular.isDefined(f.fieldsInfo))for(var g=0;g<f.fieldsInfo.length;g++)if("properties.label"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}}var h=J[e];return a[h].push(f),G.selected.item=f,k(),f}function r(a){return-1!==I.indexOf(a)}function s(){return G}function t(a){H=a}function u(){return H}function v(){if(null!==H){var a=J[G.selected.list.section],c=updateControlsId(angular.copy(H.$modelValue),a);H.$parentNodeScope.$modelValue[a].push(c),k(),b(function(){$("#defaultPage").enhanceWithin()},1)}}function w(a){var b=G.lists[a].listName;G.lists.splice(a,1),G.selected.list&&G.selected.list.listName===b&&(G.selected.list={}),k()}function x(){$.indexedDB("id-app").deleteDatabase()}function y(a,b,c){return b||(b=0),c=c?c:"children",angular.isArray(a)?angular.forEach(a,function(a,d){b=y(a,b+1,c)}):(angular.isDefined(a.properties)&&(K=a),angular.forEach(a[c],function(a,d){b=y(a,b+1,c)})),b}function z(){return K}var A={},B={type:"Content",zone:"content",properties:{id:"dummyId"},children:[],categorieschildren:[]},C="TCMD",D="ControlServiceValues",E="appStore",F=a.defer(),G={controls:[],lists:[],selected:{list:null,listIndex:-1,item:null}},H=null;A.initialize=f,f(),A.createList=g,A.setSelectedList=h,A.setSelecedListName=i,A.getSelectedList=j,A.persistData=k;var I=["Tabs","RadioGroup","CheckboxGroup","Grid","SelectMenu","Collapsible","Block","Content","Div","TabRoot","Collapsible","CollapsibleSet","CategoriesButtons","CategoriesButtonsStems"];A.getControls=l,A.getSelected=m;var J={diagnose:"children",categories:"categorieschildren",personalData:"children"};A.getChildNodeAttr=n,A.addNewSubItem=q,A.isContainer=r,A.getServiceValues=s,A.setSelectedItemScope=t,A.getSelectedItemScope=u,A.duplicateSelectedItem=v,A.removeList=w,A.deleteDB=x;var K=null;return A.findDeepestNode=y,A.getDeepestNode=z,A}angular.module("controls-module").service("ControlsService",a),a.$inject=["$q","$timeout","FieldsGeneratorService","DBService","IdentityService"]}();
//# sourceMappingURL=ControlsService.js.map
/* Min file (c) */
!function(){function a(a){function b(){a.getValue("TabOptionsDataServiceValues").then(function(a){a&&angular.forEach(a,function(a,b){g[b]=a})})}function c(){return g}function d(a){return g[a]}function e(b,c){g[b]=c,a.setValue("TabOptionsDataServiceValues",g)}var f={},g={};return f.initialize=b,b(),f.getValues=c,f.getTabOptions=d,f.setTabOptions=e,f}angular.module("controls-module").service("TabOptionsDataService",a),a.$inject=["DBService"]}();
//# sourceMappingURL=TabOptionsDataService.js.map
/* Min file (c) */
!function(){function a(a,b,c,d){function e(a,b){a.heirarchyLabels||(a.heirarchyLabels=[]),a.heirarchyLabels=(angular.isDefined(b)&&angular.isDefined(b.heirarchyLabels)?angular.copy(b.heirarchyLabels):[]).concat(a.heirarchyLabels);var c=f(a);c&&a.heirarchyLabels.push(c)}function f(a){return"Collapsible"===a.type&&a.properties.heading?a.properties.heading:"CheckboxGroup"===a.type&&a.name?a.name:void 0}function g(a,b){angular.isUndefined(b)||(a.heirarchyLabels=b.heirarchyLabels?angular.copy(b.heirarchyLabels):[])}function h(a){d.set("RadioGroupCount",d.get("RadioGroupCount")+1),a.controls.groupname="RadioGroup"+d.get("RadioGroupCount"),a.controls.labelPrefix=d.get("tabHierarchyHeadings"),a.controls.name=a.controls.properties.legend,void 0===a.controls.properties.id&&(a.controls.properties.id="RadioGroup"+d.get("RadioGroupCount"));var c=b.getTabOptions(a.controls.properties.tabId);a.$watch("controls.value",function(b,e){if(void 0!==b){var f={controlId:a.controls.properties.id,label:a.controls.labelPrefix+a.controls.properties.legend,heirarchyLabels:a.controls.heirarchyLabels,type:a.controls.type,valueLabel:a.controls.value,value:a.controls.value,labelPrefix:a.controls.labelPrefix,categoriesInfo:a.controls.categorieschildren,control:a.controls};r(f),d.get("SelectedControls")[a.controls.properties.id]=f,a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(f),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&c&&c.properties.useClassificationPanelInput&&q()}else delete d.get("SelectedControls")[a.controls.properties.id],a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0)}),p(a,c)}function i(a){a.controls.name=a.controls.properties.legend,angular.forEach(a.controls.children,function(b,c){b.name=a.controls.name})}function j(a,e){var f=d.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(f)?f:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var g=b.getTabOptions(a.controls.properties.tabId);p(a,g),a.$watch("controls.value",function(b,e){if(b!==!0||e!==!1&&void 0!==e)b===!1&&e===!0&&(c.hasControl(a.controls.properties.id)&&c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0));else{var f={controlId:a.controls.properties.id,label:a.controls.name?a.controls.name:"",heirarchyLabels:a.controls.heirarchyLabels,type:a.controls.type,valueLabel:a.controls.properties.label,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};r(f),c.addControl(a.controls.properties.id,f),a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(f),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&g.properties.useClassificationPanelInput&&q()}})}function k(a,e){a.controls.value||(a.controls.value=0);var f=d.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(f)?f:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var g=b.getTabOptions(a.controls.properties.tabId);e.on("change",'input[type="number"]',function(){var b=parseInt($(this).val());if(!(0>=b)){a.controls.value=b;var e={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.value,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};r(e),c.addControl(a.controls.properties.id,e),d.setRecentlySelectedControlDetails(e),a.controls.showCategory=!0,!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&g&&g.properties.useClassificationPanelInput&&q(),a.$apply()}}),a.$watch("controls.value",function(a){$(e).find('input[type="number"]').val(a).slider().slider("refresh")}),p(a,g)}function l(a){var e=d.get("uniqueProperty");a.controls.uniqueProperty=e,a.controls.properties.id=e+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var f=b.getTabOptions(a.controls.properties.tabId);a.$watch("controls.value",function(b,e){if(void 0!==b&&""!==b){var g={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.value,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren,control:a.controls};r(g),c.addControl(a.controls.properties.id,g),a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(g),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&f&&f.properties.useClassificationPanelInput&&q()}else c.hasControl(a.controls.properties.id)&&c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0)}),p(a,f)}function m(a){d.set("SliderCount",d.get("SliderCount")+1),void 0===a.controls.properties.id&&(a.controls.properties.id="ToggleSwitch"+d.get("SliderCount")),(void 0===a.controls.properties.label||""===a.controls.properties.label)&&(a.controls.properties.label=d.get("TextLabel")),d.set("TextLabel","");var e=d.get("uniqueProperty");a.controls.uniqueProperty=angular.isDefined(e)?e:"",a.controls.properties.id=a.controls.uniqueProperty+a.controls.properties.id,a.controls.labelPrefix=d.get("tabHierarchyHeadings");var f=b.getTabOptions(a.controls.properties.tabId);a.controls.value="false",a.$watch("controls.value",function(b,e){if("true"===b&&"false"===e){var g={controlId:a.controls.properties.id,label:a.controls.properties.label,type:a.controls.type,valueLabel:a.controls.properties.label1,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren};r(g),c.addControl(a.controls.properties.id,g),a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(g),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&f&&f.properties.useClassificationPanelInput&&q()}else"false"===b&&(c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0))}),p(a,f)}function n(a){var b=a.controls,c=b.properties&&b.properties.rows?b.properties.rows:1;void 0===b.properties&&(b.properties={}),b.properties.uiClass=GridBuilder.getGridClass(b.children,c),GridBuilder.setGridControlLabels(b)}function o(a,e){d.set("SelectMenuCount",d.get("SelectMenuCount")+1),void 0===a.controls.properties.id&&(a.controls.properties.id="SelectMenu"+d.get("SelectMenuCount")),a.controls.labelPrefix=d.get("tabHierarchyHeadings"),a.controls.properties.options&&a.controls.properties.options.children&&(a.controls.previousValue=a.controls.value=a.controls.defaultValue=a.controls.properties.options.children[0].value,a.controls.previousValueLabel=a.controls.valueLabel=a.controls.defaultValueLabel=a.controls.properties.options.children[0].text);var f=b.getTabOptions(a.controls.properties.tabId);e.on("change","select.control",function(b){var e=$(this).val(),g=$('option[value="'+e+'"]:selected',$(this)).text();if(e!==a.controls.previousValue&&e!==a.controls.defaultValue||g!==a.controls.previousValueLabel&&g!==a.controls.defaultValueLabel){a.controls.previousValue=a.controls.value,a.controls.previousValueLabel=a.controls.valueLabel,a.controls.value=e,a.controls.valueLabel=g;var h={controlId:a.controls.properties.id,label:a.controls.properties.label||a.controls.properties.options.label,type:a.controls.type,valueLabel:a.controls.valueLabel,labelPrefix:a.controls.labelPrefix,value:a.controls.value,categoriesInfo:a.controls.categorieschildren};r(h),c.addControl(a.controls.properties.id,h),a.controls.showCategory=!0,d.setRecentlySelectedControlDetails(h),!d.getIsControlsValuesBeingSet()&&a.controls.attachCategories&&f&&f.properties.useClassificationPanelInput&&q()}else c.removeControl(a.controls.properties.id),a.controls.showCategory=!1,d.setRecentlySelectedControlDetails(void 0);a.$digest()}),p(a,f)}function p(a,b){if(a.controls.attachCategories&&b&&b.properties.useClassificationPanelInput&&!a.controls.categorieschildren){var c=angular.copy(b.categoriesList.controls[0].categorieschildren);updateId(a.controls.properties.id,d.get("uniqueProperty"),c),d.get("ClassificationDataAdded").push({controlId:a.controls.properties.id,uniqueProperty:d.get("uniqueProperty"),classification:c}),a.controls.categorieschildren=c}}function q(){$("#leftpanel").panel("open"),$("#closePanelButton").removeClass("ui-btn-active")}function r(a){var b=(a.labelPrefix?a.labelPrefix:"")+(a.label?(a.labelPrefix?" : ":"")+a.label:"")+(a.heirarchyLabels&&a.heirarchyLabels.length>0?" : "+a.heirarchyLabels.join(" : "):"");a.controlLabel=b}var s={};return s.processHierarchyLabelsForContainer=e,s.processHierarchyLabelsForControl=g,s.processRadioGroup=h,s.processCheckboxGroup=i,s.processCheckbox=j,s.processSlider=k,s.processTextInput=l,s.processToggleSwitch=m,s.processGrid=n,s.processSelectMenu=o,s}angular.module("controls-module").service("DirectiveHelperService",a),a.$inject=["ControlsService","TabOptionsDataService","SelectedControlsService","SharedDataService"]}();
//# sourceMappingURL=DirectiveHelperService.js.map
/* Min file (c) */
!function(){function a(){function a(){return l}function b(a,b){l.selectedControls[a]=b}function c(a){delete l.selectedControls[a]}function d(a){return angular.isDefined(l.selectedControls[a])}function e(a){angular.forEach(l.selectedControls,function(b,c){var d=f(a,c);console.log(d),null!==d&&(l.selectedControls[c].control=d)})}function f(a,b){if(angular.isArray(a)){for(var c=0;c<a.length;c++){var d=a[c];if(d.properties&&d.properties.id===b)return d;if(d.children)return f(d.children,b)}return foundControl}return a.properties&&a.properties.id===b?a:a.children?f(a.children,b):null}function g(){return l.selectedControls}function h(){var a={};return angular.forEach(l.selectedControls,function(b,c){a[c]=b}),a}function i(a){l.selectedControls=a}function j(){l.selectedControls={}}var k={},l={selectedControls:{}};return k.getValues=a,k.addControl=b,k.removeControl=c,k.hasControl=d,k.updateSelectedControls=e,k.getSelectedControls=g,k.getSelectedControlsCopy=h,k.setSelectedControls=i,k.clearSelectedControls=j,k}angular.module("selected-controls-module",[]).service("SelectedControlsService",a)}();
//# sourceMappingURL=SelectedControlsService.js.map
/* Min file (c) */
!function(){function a(a,b,c){function d(){f=e.model={listName:"",listNameEdit:!1,section:"",selectedListIndex:null},f.controlsServiceValues=a.getServiceValues(),f.listSectionServiceValues=b.getServiceValues()}var e=this,f=e.model={};d(),e.createList=function(){if(""===f.listName)return void c.setMessage(c.ENTER_LIST_NAME_MSG);var b=f.listSectionServiceValues.selectedSection;return""===f.listSectionServiceValues.selectedSection?void c.setMessage(c.SELECT_SECTION_MSG):-1===a.createList(f.listName,void 0,b)?void c.setMessage(c.LIST_EXISTS_MSG):void 0},e.onChangeSection=function(){},e.onRemoveList=function(b){b.stopPropagation(),null!==f.selectedListIndex&&(a.removeList(f.selectedListIndex),e.selectedListName="")},e.onSelectList=function(){f.selectedListIndex=_.pluck(f.controlsServiceValues.lists,"listName").indexOf(e.selectedListName)},e.loadList=function(){console.log(f.selectedListIndex),null!==f.selectedListIndex&&(a.setSelectedList(f.selectedListIndex),f.listName=a.getSelectedList().listName,f.listNameEdit=!0,setTimeout(function(){$("#defaultPage").enhanceWithin()},1))},e.saveListName=function(){a.setSelecedListName(f.listName)},e.cancelSaveListName=function(){f.listNameEdit=!1}}angular.module("list-section-module",["notifications-module","controls-module"]).controller("CreateListController",a),a.$inject=["ControlsService","ListSectionService","NotificationsService"]}();
//# sourceMappingURL=CreateListController.js.map
/* Min file (c) */
!function(){function a(a,b,c,d){function e(){g.errorMsg="",g.itemLabel="",g.itemType="",g.selectedControlsType="",g.listSectionServiceValues=d.getServiceValues()}var f=this,g=f.model={};e(),f.add=function(){var d=a.getSelectedItemScope();if(null===d)return void b.setMessage(b.SELECT_CONTAINER_MSG);var e=d.$modelValue;if(!a.isContainer(e.type))return void b.setMessage(b.SELECT_CONTAINER_MSG);if(""===g.itemLabel)return void b.setMessage(b.ENTER_ITEM_LABEL_MSG);b.resetMessage();var f=a.getSelected().list.section;a.addNewSubItem(e,g.itemLabel,g.itemType,f),c(function(){$("#defaultPage").enhanceWithin()},1)},f.duplicate=function(){a.duplicateSelectedItem()}}angular.module("list-section-module").controller("CreateListItemController",a),a.$inject=["ControlsService","NotificationsService","$timeout","ListSectionService"]}();
